 ...
 * @param color 填充颜色
 */
class Annular extends egret.Sprite{
    private centerPoint = {
        x:0,
        y:0
    }
    ...
    public constructor(x,y,r,r2,color){
        super();
     ...
     */
    public setPercentWithAnimation(percent:number,time:number):void{
        if(percent <= 0 || percent >100){
            return;
        }
        var speed = time/360;
